...
public enum AuthType {
    BASIC_AUTH, SIG4, NONE;

    public static final AuthType DEFAULT = AuthType.NONE;
    ...
    public static String[] names() {
        final AuthType[] behaviors = values();
    ...
    public static AuthType forValue(final String value) {
